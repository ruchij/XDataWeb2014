...
<body>
	<%
		...
		if ((contentType != null)
			...
			/*	try {
					//FIXME some times this command waits infinitely for password. How to handle it
			      String command="psql -h "+hostname+"  -d  " +dbName+" -U  "+username+"  -a  -f  "+saveFile;
				  Process p = Runtime.getRuntime().exec(command);
				  int value=p.waitFor();
				 // out.println("command: "+command); 
				 // out.println("exited with value: "+value);
				}
			 */
