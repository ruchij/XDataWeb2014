...
<%
	...
	*/
	...
	stmt1.setInt(1, Integer.valueOf(assignID));
	stmt1.setString(2, courseID);
	ResultSet rs1 = stmt1.executeQuery();
	
	System.out.println("Made DB connection... for Assign:"+assignID+" Course:"+courseID);
	...
	out.println("<input type=\"submit\" name=\"submission\" value=\"Submit\"> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type=\"button\" name=\"back\" value=\"Back\" onclick=\"window.location.href='asgnmentList.jsp?assignment_id="+assignID+"\"/><br>");
