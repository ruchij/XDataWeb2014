			...
			<fieldset>
				...
				<%
					...
					try {
						...
						stmt = dbcon
								.prepareStatement("SELECT * FROM  assignment where course_id=? ORDER BY assignment_id");
						...
						while (rs.next()) {
							...
							output += "<a class=\"header\" target=\"rightPage\" href=\"assignmentImport.jsp?assignment_id="+rs.getString("assignment_id")+"&course_id="+rs.getString("course_id")+"\" ><li> Assignment "
									+ rs.getString("assignment_id")+ "</li></a>";
							
							// output += "<a class=\"header\"  target=\"rightPage\" href=\"#\" onclick=\"getAssignments('"+rs.getString("course_id")+"'); >	+ rs.getString("course_id")+ "</a>";
						}
