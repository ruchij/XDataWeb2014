			...
			<fieldset>
							...
							try {
								...
								while (rs.next()) {
									...
									if (rs1.next()){
										...
										verified = rs1.getBoolean("verifiedcorrect");
									}
				...
				%>
							...
							<div class="questionelement">
								...
								<div class = "status"><span style='font-weight:bold;'>Status:</span><%= verified ? "<font color='green'> Ok" : "<font color='red'> Incorrect" %></font></div>
								</div>								
							</div>
						<%
